    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteSaveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(length < 1){
                    Toast.makeText(EditNote.this, getResources().getString(R.string.noInput), Toast.LENGTH_LONG).show();
                }
                else{
                    if(noteId == -1){
                    ...
                    SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(EditNote.this);
